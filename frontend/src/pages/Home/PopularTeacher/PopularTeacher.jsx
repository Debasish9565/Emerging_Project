        ...
        <>
          <div className="grid mb-28 md:grid-cols-2 lg:grid-cols-4 w-[90%] gap-4 mx-auto">
            {instructors?.slice(0, 4).map((instructor, i) => (
              <div className="flex dark:text-white hover:-translate-y-2 duration-200 cursor-pointer flex-col shadow-md py-8 px-10 rounded-md">
                <div className="flex-col flex gap-6 md:gap-8">
                  ...
                  <div className="flex flex-col text-center">
                    ...
                    <p className="text-secondary flex gap-10 mb-4 whitespace-nowrap top-24">
