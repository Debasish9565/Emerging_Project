...
const Instructors = () => {
  ...
  return (
    <div className="">
      ...
      <div className="md:h-[300px] h-full  my-24 bg-secondary">
        <div class="md:h-[300px] text-white bg-black flex justify-center items-center bg-opacity-40">
          <div class="flex md:flex-row flex-col py-7 gap-16">
            <div class="text-center">
              <h1 class="text-5xl font-bold">
                <span>35</span>M+
              </h1>
              <p class="font-bold text-lg">Visitor</p>
            </div>
            <div class="text-center">
              <h1 class="text-5xl font-bold">
                <span>5</span>M+
              </h1>
              <p class="font-bold text-lg">Subscriber</p>
            </div>
            <div class="text-center">
              <h1 class="text-5xl font-bold">
                <span>950</span>k+
            ...
            <div class="text-center">
              ...
              <p class="font-bold text-lg">Success stories</p>
            </div>
          </div>
        </div>
      </div>
      <footer aria-label="Site Footer" class="bg-white dark:bg-black">
        <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
          <div class="mx-auto max-w-md">
            <strong class="block dark:text-white text-center text-xl font-bold text-gray-900 sm:text-3xl">
            ...
            <form class="mt-6">
              <div class="relative max-w-lg">
                ...
                />
                <button class="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-secondary dark: px-5 py-3 text-sm font-medium text-white transition hover:bg-opacity-60">
                  Subscribe
                </button>
              </div>
            </form>
          ...
          <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
            <div class="mx-auto max-w-sm lg:max-w-none">
              ...
              <div class="mt-6 flex justify-center gap-4 lg:justify-start">
                <a
                  class="text-secondary dark:text-white dark:hover:text-secondary transition hover:text-secondary dark:/75"
                  href=""
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  class="text-secondary dark:text-white dark:hover:text-secondary transition hover:text-secondary"
                  href=""
                  target="_blank"
                  rel="noreferrer"
                  previewlistener="true"
            ...
            <div class="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
              <div>
                <strong class="font-bold dark:text-white text-gray-900">
                  {" "}
                  Services{" "}
                </strong>
                <nav
              ...
              <div>
                <strong class=" dark:text-white font-bold text-gray-900">
                  {" "}
                  Support{" "}
                </strong>
                <nav
          ...
          <div class="mt-16 border-t border-gray-100 pt-8">
            <p class="text-center text-xs/relaxed text-gray-500">
              ...
              <br />
              Created with &nbsp;
              <a class="text-secondary dark: underline transition hover:text-secondary dark:/75">
                Yoga Master
              </a>
            </p>
          </div>
